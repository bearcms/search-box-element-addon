...
return [
    'bearcms/search-box-element-addon/Search box' => 'Търсачка',
    'bearcms/search-box-element-addon/Input' => 'Поле за писане',
    'bearcms/search-box-element-addon/Button' => 'Бутон за търсене',
